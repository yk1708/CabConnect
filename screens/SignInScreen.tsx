  ...
  >
    <View className="flex-1 bg-white relative">
      ...
      <View className="flex-col items-center space-y-2 mt-20">
        ...
        <Text className="text-white text-4xl font-extrabold mt-4">Sign in to your</Text>
        <Text className="text-white text-4xl font-extrabold mt-1"> Account</Text>
      ...
      <View className="flex-1 justify-center px-6 mt-20">
        <View className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <View className="flex-row items-center mb-5">
            ...
            <Text className="text-sm text-gray-500 mx-2 text-center">Or login with</Text>
            <View className="flex-1 border-t border-gray-300" />
          </View>
          ...
          <View className="flex-row items-center justify-between mb-6">
            ...
            >
              <CheckBoxIcon value={rememberMe} onToggle={toggleRememberMe} size={20} color="blue" />
